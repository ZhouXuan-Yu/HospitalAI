...
HospitalAI 是面向医院内部部署的临床药学 AI 决策与科研数据工作台。项目聚焦“处方推荐与审核”和“患者追踪与科研沉淀”两条主线：帮助医生在开方前核对患者事实、规则和证据，帮助药师完成处方审核、点评、药历与用药教育，并把经过确认的诊疗事件沉淀为可追溯的科研资产。
...
- **AI Service**：FastAPI，用于 AI 解释、证据检索和科研分析能力的服务化封装。
