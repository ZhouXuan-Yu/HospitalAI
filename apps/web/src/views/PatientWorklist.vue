<template>
  <div class="product-page">
    <header class="page-heading">
      ...
      <div class="page-heading-actions"><el-button :icon="RefreshCw">刷新列表</el-button><el-button type="primary" :icon="UserRoundSearch">读取 HIS 患者上下文</el-button></div>
    </header>
...
const filteredRows = computed(() => previewWorklist.filter(row => {
