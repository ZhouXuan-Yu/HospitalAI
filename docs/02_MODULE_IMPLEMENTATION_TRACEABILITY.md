...
| R-012 | 科研数据 | 支撑报告草稿 | 队列、变量、数据质量、冻结 | 部分完成：研究队列、变量字典、质量检查、冻结版本和报告草稿审核 API 已通；固定 Python 统计、脱敏导出和知识发布待补 | `research` 模块、`research_cohort`、`research_variable`、`research_dataset_quality_check`、`research_report_draft` | 缺失统计、版本复现、脱敏导出、报告审核 |
